...
(function (bardTests) {
    ...
    var MyService = (function () {
        ...
        MyService.prototype.remoteCall = function () {
    ...
    function test_debugging() {
        console.log(bard.debugging(true), // should return true
    ...
    function test_inject() {
        var _this = this;
        beforeEach(function () { return bard.inject(_this, '$controller', '$log', '$q', '$rootScope', 'myService'); });
    }
    /*
     * bard.log
     */
    ...
    function test_mockService() {
        var controller, myArray = ['This', 'is', 'some', 'mocked', 'data'];

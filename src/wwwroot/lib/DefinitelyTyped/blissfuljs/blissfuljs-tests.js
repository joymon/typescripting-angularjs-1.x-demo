...
function $_delegate_test() {
    var element = $(".selector");
    $.delegate(element, "locationchange", ".selected", function () { });
    ...
    element._.delegate("locationchange", ".selected", function () { });
...
function $_lazy_test() {
    var x = { a: "" };
    $.lazy(x, "foo", function () { return "bar"; });
    $.lazy(x, {
        "foo": function () {
            return "bar";
        }
...
function $_live_test() {
    var x = { a: "" };
    $.live(x, "foo", function () { return "bar"; });
}
function $_type_test() {
    var args = [];

...
alertify.alert("This is an alert with a callback", function () {
    alertify.success("Alert finished");
}, "myCustomClass");
alertify.confirm("This is a confirm request");
alertify.confirm("This is a confirm request with a callback", function () {
...
alertify.prompt("prompt message 2", function () { console.log("callback"); }, "ok", "myClass");

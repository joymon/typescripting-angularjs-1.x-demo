...
checkGridOptions({});
checkColDef({});
function checkGridOptions(gridOptions) {
    ...
    gridOptions.doesExternalFilterPass = function (node) { return false; };
    gridOptions.getRowStyle = function () { };
    gridOptions.getRowClass = function () { };
    gridOptions.headerCellRenderer = function () { };
    gridOptions.groupAggFunction = function (nodes) { };
    gridOptions.onReady = function (api) { };

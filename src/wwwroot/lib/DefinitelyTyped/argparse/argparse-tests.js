...
var args;
var simpleExample = new argparse_1.ArgumentParser({
    version: '0.0.1',
    addHelp: true,
...
console.dir(args);
console.log('-----------');
var choicesExample = new argparse_1.ArgumentParser({
    version: '0.0.1',
    addHelp: true,
...
// console.dir(args);
var constantExample = new argparse_1.ArgumentParser({
    version: '0.0.1',
    addHelp: true,
...
console.dir(args);
var nargsExample = new argparse_1.ArgumentParser({
    version: '0.0.1',
    addHelp: true,
...
console.log(args);
var bar_parser = new argparse_1.ArgumentParser({
    parents: [parent_parser],
    description: 'child2'
});
...
console.log(args);
var prefixCharsExample = new argparse_1.ArgumentParser({
    version: '0.0.1',
    addHelp: true,
...
console.dir(args);
var subparserExample = new argparse_1.ArgumentParser({
    version: '0.0.1',
    addHelp: true,
...
var functionExample = new argparse_1.ArgumentParser({ description: 'Process some integers.' });
function sum(arr) {
...
var formatterExample = new argparse_1.ArgumentParser({
    prog: 'PROG',
    formatterClass: argparse_1.RawDescriptionHelpFormatter,

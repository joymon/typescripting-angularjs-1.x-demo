...
(function (TestQ) {
    ...
    {
        var result_1;
        result_1 = new $q(function (resolve) { });
        result_1 = new $q(function (resolve, reject) { });
        result_1 = $q(function (resolve) { });
        result_1 = $q(function (resolve, reject) { });
    }
    // $q.all
    {
        var result_2;
        result_2 = $q.all([promiseAny, promiseAny]);
    ...
    {
        var result_3;
        result_3 = $q.all([promiseAny, promiseAny]);
    }
    {
        var result_4;
        result_4 = $q.all({ a: promiseAny, b: promiseAny });
    }
    {
        var result_5;
        result_5 = $q.all({ a: promiseAny, b: promiseAny });
    }
    // $q.defer
    {
        var result_6;
    ...
    {
        var result_9;
        result_9 = $q.resolve(tResult);
        result_9 = $q.resolve(promiseTResult);
    }
    // $q.when
    {
        var result_10;
    ...
    {
        var result_11;
        result_11 = $q.when(tResult);
        result_11 = $q.when(promiseTResult);
    }
})(TestQ || (TestQ = {}));
var httpFoo;
...
(function (TestDeferred) {
    ...
    {
        var result_12;
        result_12 = deferred.resolve();
        result_12 = deferred.resolve(tResult);
    }
    // deferred.reject
    {
        var result_13;
        result_13 = deferred.reject();
        result_13 = deferred.reject(any);
    }
    // deferred.notify
    {
        var result_14;
        result_14 = deferred.notify();
        result_14 = deferred.notify(any);
    }
    // deferred.promise
    {
        var result_15;
        result_15 = deferred.promise;
    }
...
(function (TestTimeout) {
    ...
    }
    {
        var result_17;
        result_17 = $timeout(1);
        result_17 = $timeout(1, true);
    }
    {
        var result_18;
        result_18 = $timeout(fnTResult);
        result_18 = $timeout(fnTResult, 1);
        result_18 = $timeout(fnTResult, 1, true);
        result_18 = $timeout(fnTResult, 1, true, 1);
        result_18 = $timeout(fnTResult, 1, true, 1, '');
        result_18 = $timeout(fnTResult, 1, true, 1, '', true);
    }
    // $timeout.cancel
    {
        var result_19;
        result_19 = $timeout.cancel();
        result_19 = $timeout.cancel(promiseAny);
    }

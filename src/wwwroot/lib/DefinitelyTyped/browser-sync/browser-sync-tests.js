...
browser.stream({ match: function (testString) { return true; } });
// -- "match" option (array).
browser.stream({ match: ["**/*.js", /\.js$/, function (testString) { return true; }] });
// -- Both options.
browser.stream({ once: true, match: ["**/*.js", /\.js$/, function (testString) { return true; }] });
